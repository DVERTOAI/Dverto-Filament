...
>
    ...
    <div class="fi-pagination-end">
        <div class="fi-pagination-nav-btns">
            <x-filament::button
                color="gray"
            ...
            <ol class="fi-pagination-items">
                @if (! $paginator->onFirstPage())
                    ...
                    <x-filament::pagination.item
                        ...
                        :wire:key="$this->getId() . '.pagination.previous.item'"
                    />
                @endif
                ...
                @if ($paginator->hasMorePages())
                    <x-filament::pagination.item
                        ...
                        :wire:key="$this->getId() . '.pagination.next.item'"
                    />
